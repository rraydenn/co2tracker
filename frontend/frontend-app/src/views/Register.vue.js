...
exports.default = (0, vue_1.defineComponent)({
    setup: function () {
        ...
        var register = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, authStore.register(full_name.value, email.value, password.value)];
                    case 1:
                        _a.sent();
        ...
        var animateForm = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (boxRef.value) {
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "container" }, { key: "register-page" }));
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)(__assign({ onSubmit: (__VLS_ctx.register) }, { class: "form" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "form-group" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ for: "full_name" }, { class: "form-label" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign(__assign({ type: "text", value: (__VLS_ctx.full_name), placeholder: "Enter your name", required: true }, { class: "form-input" }), { disabled: (!__VLS_ctx.isActive) }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "form-group" }));
...
// @ts-ignore
var __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4(__assign(__assign({ 'onClick': {} }, { to: "/login" }), { class: "link" })));
var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([__assign(__assign({ 'onClick': {} }, { to: "/login" }), { class: "link" })], __VLS_functionalComponentArgsRest(__VLS_5), false));
var __VLS_8;
var __VLS_9;
var __VLS_10;
var __VLS_11 = {
    onClick: function () {
        ...
        var $event = _a[0];
        __VLS_ctx.setTransition('slide-left');
    }
};
